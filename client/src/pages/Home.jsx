...
export default function Home() {
  ...
  return (
    <div className='p-3 flex flex-col max-w-5xl mx-auto min-h-screen'>
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl justify-start '>
        <h1 className='lex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-slate-700 dark:text-white ss:leading-[100px] leading-[75px] '><span className='text-black-300'>Welcome to</span> Colo<span className='text-gradient'>Gram</span></h1>
        ...
        {/* <div className="absolute z-[0] w-[40%] h-[35%] bottom-0 pink__gradient" /> */}
          ...
          <div className="absolute z-[0] w-[20%] h-[50%] top-0 right-0 bottom-20 blue__gradient" />
      ...
      <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 py-7'>
        {posts && posts.length > 0 && (
          <div className='flex flex-col m-5 items-center gap-6'>
            <h2 className='text-3xl border-b dark:border-gray-700 max-w-fit font-semibold text-center'>Recent Posts</h2>
